...
class SendAnalyticCommand extends BaseSendCommand
{
    protected const string START_OUTPUT = "Start sending analytics";
    ...
    public function __construct(
        ...
        parent::__construct($pathToMessages, $publisher, 'app:send-analytics');
    }
}
